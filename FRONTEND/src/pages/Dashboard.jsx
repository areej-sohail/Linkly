  ...
  return (
    <>
      ...
      <div className='text-center mt-12'>
        <div className="fade-up inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs tracking-widest text-violet-400 mb-8 border border-violet-500/30 bg-violet-500/10">
          <span className="pulse-dot w-1.5 h-1.5 rounded-full bg-violet-400 inline-block"></span>
          NOW WITH ANALYTICS DASHBOARD
        </div>

        <h1 className='leading-tight tracking-tight fade-up bg-linear-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent font-extrabold text-[clamp(2rem,5vw,3rem)] w-fit mx-auto'>
          Every link, under control
        </h1>

        <h2 className='fade-up leading-relaxed text-slate-500 mt-5 max-w-md text-lg mx-auto'>
